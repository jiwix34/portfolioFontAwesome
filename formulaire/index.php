...
<html>
  ...
  <body>
    ...
    <footer class="col-xs-12 contactphp" id="contact">
      <section>
      ...
      <div class="row">
        <div class="col-xs-6">
          <div class="form-group">
            ...
            <input type="text" name="nom" class="form-control" id="inputnom" value="<?= isset($_SESSION['inputs']['nom']) ? $_SESSION['inputs']['nom'] : ''; ?>">
          </div>
        </div>
        <div class="col-xs-6">
          <div class="form-group">
...
<script type="text/javascript" src="../javascript/grandeur.js"> </script>
<script type="text/javascript" src="../javascript/centrage.js"> </script>
